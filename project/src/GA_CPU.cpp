            ...
            for (const auto &pair: parentPairs[island]) {
                ...
                if (probDist(rng) < tsp.crossoverProbability) {
                    ...
                    for (int i = 0; i < tsp.numCities; i++) {
                        ...
                        if (std::find(child1Chromosome.begin(), child1Chromosome.end(), candidate) == child1Chromosome.
                            end()) {
                    ...
                    for (int i = 0; i < tsp.numCities; i++) {
                        ...
                        if (std::find(child2Chromosome.begin(), child2Chromosome.end(), candidate) == child2Chromosome.
                            end()) {
